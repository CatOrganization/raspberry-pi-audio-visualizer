...
PROJECT_SOURCE_FILES ?= src/main.c src/filter.c src/effects.c src/linked_list.c src/firework.c src/wave_line.c src/vis_fireworks_and_waves.c src/vis_sound_wave.c
